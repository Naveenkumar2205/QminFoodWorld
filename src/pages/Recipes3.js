import styles from "./Recipes3.module.css";

const recipes3 = () => {
  return (
    <div className={styles.recipes3}>
      <div className={styles.recipes3Child} />
      ...
      <div className={styles.rectangleGroup}>
        ...
        <div className={styles.groupFrame}>
          <div className={styles.aboutUsParent}>
            ...
            <b className={styles.recipes31}>recipes3</b>
      ...
      <div className={styles.recipes3Inner}>
      ...
      <div className={styles.recipes3Inner1}>
        <div className={styles.recipes3Wrapper}>
          <b className={styles.recipes32}>recipes3</b>
        </div>
      </div>
      <img className={styles.image29Icon} alt="" src="/image-29@2x.png" />
      <div className={styles.easyPaneerBiryaniParent}>
        <b className={styles.easyPaneerBiryani}>Easy Paneer Biryani</b>
        <div className={styles.biryaniYaaniqminfoodworld}>
          Biryani yaani...Qminfoodworld! Today's special: Paneer Biryani that
          you can cook and enjoy at home. The secret to nailing this
          lip-smacking Paneer Biryani is the finest quality of long-grain rice.
          Kyuki jab Qmin food world long grain Basmati Rice se khana banega, toh
          farq dikhega.
        </div>
      </div>
      <div className={styles.rectangleParent1}>
        ...
        <div className={styles.ingredientsParent}>
          ...
          <div className={styles.stepByStep}>Step by step guide</div>
        </div>
      </div>
      <div className={styles.recipeVariants}>Recipe Variants</div>
      <div className={styles.tab}>
        <img
          className={styles.madeEasyIconpng}
          alt=""
          src="/made-easy-iconpng@2x.png"
        />
        <div className={styles.madeEasy}>MADE EASY</div>
      </div>
      <div className={styles.redOtherBlogParent}>
        <b className={styles.redOtherBlog}>Red Other Blog</b>
            ...
            <div className={styles.heading3Parent}>
              ...
              <div className={styles.linkParent}>
                <div className={styles.link}>
                  <b className={styles.viewRecipe}>View Recipe</b>
                </div>
      ...
      <div className={styles.listWrapper}>
        <div className={styles.list}>
          <div className={styles.item}>
            ...
            <div className={styles.gramsCottageCheeseContainer}>
              <p className={styles.vivaAtlierNr}>
                500 grams cottage cheese (paneer), cut into
              </p>
              <p className={styles.vivaAtlierNr}>1-inch cubes</p>
            </div>
          </div>
          ...
          <div className={styles.item5}>
            ...
            <div className={styles.gramsCottageCheeseContainer}>2-3 cloves</div>
          </div>
          ...
          <div className={styles.item7}>
            ...
            <div className={styles.gramsCottageCheeseContainer}>3-4 cloves</div>
          </div>
          ...
          <div className={styles.item27}>
            ...
            <div className={styles.gramsCottageCheeseContainer}>
              <p className={styles.vivaAtlierNr}>
                A large pinch of saffron, soaked in 1-2 tbsps
              </p>
              <p className={styles.vivaAtlierNr}>warm wat</p>
            </div>
          </div>
      ...
      <div className={styles.listContainer}>
        <div className={styles.list1}>
          <div className={styles.item40}>
            <div className={styles.pseudo}>
              <img className={styles.icon} alt="" src="/icon1.svg" />
            </div>
            <div className={styles.step1}>Step 1</div>
            <div className={styles.takeBiryaniBasmati}>
              Take Biryani Basmati Rice in a bowl. Add sufficient water and wash
              2-3 times.
            </div>
          </div>
          <div className={styles.item41}>
            ...
            <div className={styles.addSomeFresh}>
              Add some fresh water and let it soak for 25-30 minutes. Now drain
              the water.
            </div>
          </div>
          <div className={styles.item42}>
            ...
            <div className={styles.boil68CupsContainer}>
              <p className={styles.vivaAtlierNr}>
                Boil 6-8 cups of water in a deep non-stick pan. Add salt, black
                peppercorns, green cardamoms,
              </p>
              <p className={styles.vivaAtlierNr}>
                and cloves. Now add the soaked rice, mix, and then cook for
                10-15 minutes, or till the rice is ¾
              </p>
              <p className={styles.vivaAtlierNr}>
                done. Again, drain the rice.
              </p>
            </div>
          </div>
          <div className={styles.item43}>
            ...
            <div className={styles.takeBiryaniBasmati}>
              <p className={styles.vivaAtlierNr}>
                To make the masala, heat ghee in a deep pan. Add cloves, black
                peppercorns, green
              </p>
              <p className={styles.vivaAtlierNr}>
                cardamoms, bay leaves, cumin seeds, green chilies, and onions,
                and now sauté till golden
              </p>
              <p className={styles.vivaAtlierNr}>brown.</p>
            </div>
          </div>
          <div className={styles.item44}>
            ...
            <div className={styles.step1}>Step 5</div>
            <div className={styles.takeBiryaniBasmati}>
          ...
          <div className={styles.item45}>
            ...
            <div className={styles.step1}>Step 6</div>
            <div className={styles.takeBiryaniBasmati}>
              Pour the tomato puree and mix well. Add salt, mix, and cook for
              2-3 minutes.
            </div>
          </div>
          <div className={styles.item46}>
            ...
            <div className={styles.step1}>Step 7</div>
            <div className={styles.takeBiryaniBasmati}>
              <p className={styles.vivaAtlierNr}>
                Add red chili powder, turmeric powder, coriander powder, cumin
                powder, biryani masala,
              </p>
              <p className={styles.vivaAtlierNr}>
                browned onions, mint leaves, coriander leaves, and butter. Now
                mix well, and then cook on
              </p>
              <p className={styles.vivaAtlierNr}>
                medium heat till the fat separates.
              </p>
            </div>
          </div>
          <div className={styles.item47}>
            ...
            <div className={styles.step1}>Step 8</div>
            <div className={styles.addSomeFresh}>
              <p className={styles.vivaAtlierNr}>
                Reduce the heat to low, add yogurt, and mix well. Add ½ cup
                water, mix, and cook for 3-4
              </p>
              <p className={styles.vivaAtlierNr}>minutes.</p>
            </div>
          </div>
          <div className={styles.item48}>
            ...
            <div className={styles.step1}>Step 9</div>
            <div className={styles.takeBiryaniBasmati}>
              <p className={styles.vivaAtlierNr}>
                Add the paneer cubes and gently mix till well combined. Evenly
                spread the cooked rice over
              </p>
              <p className={styles.vivaAtlierNr}>
                the paneer masala. Drizzle soaked saffron, rose water, screwpine
                water, and ghee. Now
              </p>
              <p className={styles.vivaAtlierNr}>
                sprinkle browned onions, coriander sprigs, mint leaves, green
                chilies, ginger, and dried rose
              </p>
              <p className={styles.vivaAtlierNr}>petals.</p>
            </div>
          </div>
          <div className={styles.item49}>
            ...
            <div className={styles.step10}>Step 10</div>
            <div className={styles.coverThePanContainer}>
              <p className={styles.vivaAtlierNr}>
                Cover the pan with aluminum foil and place the lid on it. Cook
                on low heat for 8-10 minutes.
              </p>
              <p className={styles.vivaAtlierNr}>
                Once done, switch the heat off and transfer the paneer biryani
                to a serving plate.
              </p>
            </div>
          </div>
          <div className={styles.item50}>
            ...
            <div className={styles.step10}>Step 11</div>
            <div className={styles.garnishWithBrowned}>
              Garnish with browned onions and mint sprig. Serve hot with boondi
              raita and onion rings.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.recipes3Inner2}>
