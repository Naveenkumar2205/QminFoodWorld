...
const recipes4 = () => {
  return (
    <div className={styles.recipes4}>
      <div className={styles.recipes4Child} />
      ...
      <div className={styles.rectangleGroup}>
        ...
        <div className={styles.groupFrame}>
          <div className={styles.aboutUsParent}>
            ...
            <b className={styles.recipes4}>Recipes </b>
      ...
      <div className={styles.recipes4Inner}>
      ...
      <div className={styles.recipes4Inner1}>
        <div className={styles.recipes4Wrapper}>
          <b className={styles.recipes4}>recipes4</b>
        </div>
      </div>
      ...
      <div className={styles.recipes4Inner2}>
